...
class TendermintTypesEvidenceParams(object):
    ...
    def __init__(self, max_age_num_blocks=None, max_age_duration=None, max_bytes=None):  # noqa: E501
        """TendermintTypesEvidenceParams - a model defined in Swagger"""  # noqa: E501
    ...
    def max_age_num_blocks(self):
        """Gets the max_age_num_blocks of this TendermintTypesEvidenceParams.  # noqa: E501

        Max age of evidence, in blocks.  The basic formula for calculating this is: MaxAgeDuration / {average block time}.  # noqa: E501

        :return: The max_age_num_blocks of this TendermintTypesEvidenceParams.  # noqa: E501
        :rtype: str
        """
    ...
    def max_age_num_blocks(self, max_age_num_blocks):
        """Sets the max_age_num_blocks of this TendermintTypesEvidenceParams.

        Max age of evidence, in blocks.  The basic formula for calculating this is: MaxAgeDuration / {average block time}.  # noqa: E501

        :param max_age_num_blocks: The max_age_num_blocks of this TendermintTypesEvidenceParams.  # noqa: E501
        :type: str
        """
    ...
    def max_age_duration(self):
        """Gets the max_age_duration of this TendermintTypesEvidenceParams.  # noqa: E501
        ...
        :return: The max_age_duration of this TendermintTypesEvidenceParams.  # noqa: E501
        :rtype: str
        """
    ...
    def max_age_duration(self, max_age_duration):
        """Sets the max_age_duration of this TendermintTypesEvidenceParams.

        Max age of evidence, in time.  It should correspond with an app's \"unbonding period\" or other similar mechanism for handling [Nothing-At-Stake attacks](https://github.com/ethereum/wiki/wiki/Proof-of-Stake-FAQ#what-is-the-nothing-at-stake-problem-and-how-can-it-be-fixed).  # noqa: E501

        :param max_age_duration: The max_age_duration of this TendermintTypesEvidenceParams.  # noqa: E501
        :type: str
        """
    ...
    @property
    def max_bytes(self):
        """Gets the max_bytes of this TendermintTypesEvidenceParams.  # noqa: E501


        :return: The max_bytes of this TendermintTypesEvidenceParams.  # noqa: E501
        :rtype: str
        """
    ...
    def max_bytes(self, max_bytes):
        """Sets the max_bytes of this TendermintTypesEvidenceParams.


        :param max_bytes: The max_bytes of this TendermintTypesEvidenceParams.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TendermintTypesEvidenceParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TendermintTypesEvidenceParams):
            return False
