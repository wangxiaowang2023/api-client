...
class CosmosTxV1beta1TxBody(object):
    ...
    def __init__(self, messages=None, memo=None, timeout_height=None, extension_options=None, non_critical_extension_options=None):  # noqa: E501
        """CosmosTxV1beta1TxBody - a model defined in Swagger"""  # noqa: E501
        self._messages = None
        self._memo = None
    ...
    @property
    def messages(self):
        """Gets the messages of this CosmosTxV1beta1TxBody.  # noqa: E501
        ...
        :return: The messages of this CosmosTxV1beta1TxBody.  # noqa: E501
    ...
    def messages(self, messages):
        """Sets the messages of this CosmosTxV1beta1TxBody.

        messages is a list of messages to be executed. The required signers of those messages define the number and order of elements in AuthInfo's signer_infos and Tx's signatures. Each required signer address is added to the list only the first time it occurs. By convention, the first required signer (usually from the first message) is referred to as the primary signer and pays the fee for the whole transaction.  # noqa: E501

        :param messages: The messages of this CosmosTxV1beta1TxBody.  # noqa: E501
    ...
    @property
    def memo(self):
        """Gets the memo of this CosmosTxV1beta1TxBody.  # noqa: E501
        ...
        :return: The memo of this CosmosTxV1beta1TxBody.  # noqa: E501
        :rtype: str
        """
        return self._memo
    ...
    @memo.setter
    def memo(self, memo):
        """Sets the memo of this CosmosTxV1beta1TxBody.

        memo is any arbitrary note/comment to be added to the transaction. WARNING: in clients, any publicly exposed text should not be called memo, but should be called `note` instead (see https://github.com/cosmos/cosmos-sdk/issues/9122).  # noqa: E501

        :param memo: The memo of this CosmosTxV1beta1TxBody.  # noqa: E501
        :type: str
        """
    ...
    def timeout_height(self):
        """Gets the timeout_height of this CosmosTxV1beta1TxBody.  # noqa: E501


        :return: The timeout_height of this CosmosTxV1beta1TxBody.  # noqa: E501
        :rtype: str
        """
    ...
    def timeout_height(self, timeout_height):
        """Sets the timeout_height of this CosmosTxV1beta1TxBody.


        :param timeout_height: The timeout_height of this CosmosTxV1beta1TxBody.  # noqa: E501
        :type: str
        """
    ...
    def extension_options(self):
        """Gets the extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501


        :return: The extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501
        :rtype: list[dict(str, object)]
        """
    ...
    def extension_options(self, extension_options):
        """Sets the extension_options of this CosmosTxV1beta1TxBody.


        :param extension_options: The extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501
        :type: list[dict(str, object)]
        """
    ...
    def non_critical_extension_options(self):
        """Gets the non_critical_extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501


        :return: The non_critical_extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501
        :rtype: list[dict(str, object)]
        """
    ...
    def non_critical_extension_options(self, non_critical_extension_options):
        """Sets the non_critical_extension_options of this CosmosTxV1beta1TxBody.


        :param non_critical_extension_options: The non_critical_extension_options of this CosmosTxV1beta1TxBody.  # noqa: E501
        :type: list[dict(str, object)]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CosmosTxV1beta1TxBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CosmosTxV1beta1TxBody):
            return False
